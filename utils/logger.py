...
class PBTLLogger:
    ...
    def frontier_analysis(
        self, description: str, frontier: str, vc: Optional[str] = None
    ):
    ...
    def constraint_check(
        self, n_id: int, n_vc: str, m_vc: str, result: Optional[str] = None
    ):
...
def log_monitor_header(
    property_text: str, verdict: str, initial_frontier: Optional[str] = None
):
