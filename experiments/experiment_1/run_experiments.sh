...
# Navigate to the project root directory (two levels up from experiments/experiment_1)
PROJECT_ROOT_PATH="$(cd "$(dirname "$0")/../.." && pwd)"
RESULT_FILE="${PROJECT_ROOT_PATH}/experiments/experiment_1/result-experiment-1"

# Store results in the experiment folder
echo "########## experiment 1 ##########" >> "${RESULT_FILE}"

# Define relative paths for spec and traces from the project root
SPEC_FILE="experiments/experiment_1/spec_experiment_1.pbtl"
TRACE_DIR="experiments/experiment_1/traces"
