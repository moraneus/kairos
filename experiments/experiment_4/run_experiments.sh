...
# Navigate to the project root directory (two levels up from experiments/experiment_4)
PROJECT_ROOT_PATH="$(cd "$(dirname "$0")/../.." && pwd)"
RESULT_FILE="${PROJECT_ROOT_PATH}/experiments/experiment_4/result-experiment-4"

# Store results in the experiment folder
echo "########## experiment 4 ##########" >> "${RESULT_FILE}"

# Define relative paths for spec and traces from the project root
SPEC_FILE="experiments/experiment_4/spec_experiment_4.pbtl"
TRACE_DIR="experiments/experiment_4/traces"
