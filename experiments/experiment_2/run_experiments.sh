...
# Navigate to the project root directory (two levels up from experiments/experiment_2)
PROJECT_ROOT_PATH="$(cd "$(dirname "$0")/../.." && pwd)"
RESULT_FILE="${PROJECT_ROOT_PATH}/experiments/experiment_2/result-experiment-2"

# Store results in the experiment folder
echo "########## experiment 2 ##########" >> "${RESULT_FILE}"

# Define relative paths for spec and traces from the project root
SPEC_FILE="experiments/experiment_2/spec_experiment_2.pbtl"
TRACE_DIR="experiments/experiment_2/traces"
